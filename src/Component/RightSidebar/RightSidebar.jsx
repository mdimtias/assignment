...
const RightSidebar = () => {
  return (
    <>
      ...
      <p className="text-xs text-black my-3">
        <img src="assets/warning.png" className="me-2" alt="" /> Your location
        will help us serve better and extend a personalised experience.
      </p>
      <h3 className="my-3 fs-4 fw-semibold">
        <img src="assets/like.png" className="me-2" alt="" /> Recommended Groups
      </h3>
      <div className="follow-people-list d-flex flex-column gap-3 mb-5">
        <div className="d-flex justify-content-between align-items-center">
          <div className="d-flex align-items-center gap-2">
